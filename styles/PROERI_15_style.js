var size = 0;
var placement = 'point';
function categories_PROERI_15(feature, value, size, resolution, labelText,
...
var style_PROERI_15 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Condición");
    var labelText = "";
    size = 0;
...
var style = categories_PROERI_15(feature, value, size, resolution, labelText,
