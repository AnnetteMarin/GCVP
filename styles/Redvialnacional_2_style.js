var size = 0;
var placement = 'point';
function categories_Redvialnacional_2(feature, value, size, resolution, labelText,
...
var style_Redvialnacional_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'line';
    if (feature.get("RUTA") !== null && resolution > 0 && resolution < 28) {
        labelText = String(feature.get("RUTA"));
    }
    
var style = categories_Redvialnacional_2(feature, value, size, resolution, labelText,
